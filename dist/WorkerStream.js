...
var WorkerStream = function (_Duplex) {
  ...
  function WorkerStream(_ref) {
    var path = _ref.path,
        _ref$objectOut = _ref.objectOut,
        objectOut = _ref$objectOut === undefined ? true : _ref$objectOut;

    _classCallCheck(this, WorkerStream);

    var _this = _possibleConstructorReturn(this, (WorkerStream.__proto__ || Object.getPrototypeOf(WorkerStream)).call(this, { readableObjectMode: objectOut }));
    ...
    _this.worker.onmessage = function (e) {
      var data = objectOut ? e.data : Buffer(e.data);
      _this.push(data);
      _this.responses += 1;
      _this._done();
    };
